...
uint8_t button_get_menu_buttons()
{
	...
	if (button_start_delay == 0) {
		...
		if (gpio_get_level(BUTTON_TIME) == 0) { 
			...
			(gpio_get_level(BUTTON_RIGHT) == 0 || gpio_get_level(BUTTON_RIGHT_2) == 0) 
				&& (gpio_get_level(BUTTON_LEFT) == 0 || gpio_get_level(BUTTON_LEFT_2) == 0)) {
					
			button_start_delay = 31;
			return 0;
		}
		else if (gpio_get_level(BUTTON_RIGHT) == 0 || gpio_get_level(BUTTON_RIGHT_2) == 0) { 
			button_start_delay = 7;
			return 1;
		}
		else if (gpio_get_level(BUTTON_LEFT) == 0 || gpio_get_level(BUTTON_LEFT_2) == 0) {
			button_start_delay = 7;
			return 2;
		}
...
unsigned int button_get_four_default_buttons() 
{
...
unsigned int button_get_four_snoopytennis_buttons() 
{
...
unsigned int button_get_four_marioscementfactory_buttons() {
...
unsigned int button_get_four_flagman_lion_buttons() {
...
unsigned int button_get_four_buttons()
{
    ...
    if (button_start_delay == 0) {
		...
		if ((gpio_get_level(BUTTON_RIGHT) == 0 || gpio_get_level(BUTTON_RIGHT_2) == 0) 
			&& (gpio_get_level(BUTTON_LEFT) == 0 || gpio_get_level(BUTTON_LEFT_2) == 0)) { 
		...
		if (gpio_get_level(BUTTON_TIME) == 0) {
			...
			else if (button_control_mode == 2) {
				hw_buttons = button_get_four_marioscementfactory_buttons();
			}
			else if (button_control_mode == 3) {
