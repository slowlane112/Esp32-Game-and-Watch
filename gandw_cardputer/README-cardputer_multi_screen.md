# Game and Watch Multi Screen for the Cardputer Adv

Play Multi Screen Game and Watch games using an external display on the cardputer adv.<br>
...
If your panel is not 320x240 update /gandw_cardputer/main/display.h with the details.
...
You can adjust the position of the rendered content in /gandw_cardputer/main/display.c
...
<tr><td>gnw_bjack</td><td>Game & Watch Black Jack.gw</td></tr>
...
<tr><td>gnw_mickdon</td><td>Game & Watch Mickey & Donald.gw</td></tr>
<tr><td>gnw_opanic</td><td>Game & Watch Oil Panic.gww</td></tr>
<tr><td>gnw_pinball</td><td>Game & Watch Pinball.gw</td></tr>
<tr><td>gnw_sbuster</td><td>Game & Watch Safe Buster.gw</td></tr>
<tr><td>gnw_squish</td><td>Game & Watch Squish.gw</td></tr>
...
```
idf.py -DMODEL=cardputer_multi_screen -p /dev/ttyACM0 flash
```

You can also monitor by adding monitor at the end: 

```
idf.py -DMODEL=cardputer_multi_screen -p /dev/ttyACM0 flash monitor 
```
