...
Game games[] = {
	...
	{ .name="Ball", .year="1980", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Flagman", .year="1980", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Vermin", .year="1980", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0x0000 },
	{ .name="Fire", .year="1980", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Judge", .year="1980", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Manhole", .year="1981", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Helmet", .year="1981", .img_unit_width=120, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Lion", .year="1981", .img_unit_width=119, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Parachute", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Octopus", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Popeye", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Chef", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Mickey Mouse", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Egg", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Fire", .year="1981", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Turtle Bridge", .year="1982", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0x0000 },
	{ .name="Fire Attack", .year="1982", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0xffff },
	{ .name="Snoopy Tennis", .year="1982", .img_unit_width=133, .img_unit_height=80, .color_line=2, .text_color=0x0000 },
	{ .name="Donkey Kong Jr.", .year="1982", .img_unit_width=133, .img_unit_height=80, .color_line=6, .text_color=0xffff },
	{ .name="Mario's Cement Factory", .year="1983", .img_unit_width=133, .img_unit_height=80, .color_line=6, .text_color=0xffff },
	{ .name="Manhole", .year="1983", .img_unit_width=133, .img_unit_height=80, .color_line=6, .text_color=0xffff },
	{ .name="Tropical Fish", .year="1985", .img_unit_width=133, .img_unit_height=80, .color_line=6, .text_color=0xffff },
	{ .name="Super Mario Bros.", .year="1988", .img_unit_width=133, .img_unit_height=80, .color_line=6, .text_color=0x0000 },
	{ .name="Climber", .year="1988", .img_unit_width=133, .img_unit_height=80, .color_line=6, .text_color=0xffff },
	{ .name="Balloon Fight", .year="1988", .img_unit_width=132, .img_unit_height=80, .color_line=6, .text_color=0xffff },
	{ .name="Mario the Juggler", .year="1991", .img_unit_width=132, .img_unit_height=80, .color_line=6, .text_color=0x0000 }
	
#elif defined(MODEL_CARDPUTER_MULTI_SCREEN)    
	
	{ .name="Oil Panic", .year="1982", .img_unit_width=104, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x0000, .box_bg_color=0xef9d, .box_border_color=0xa4ac },
	{ .name="Donkey Kong", .year="1982", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x0000, .box_bg_color=0xf345, .box_border_color=0x9c8c },
	{ .name="Mickey & Donald", .year="1982", .img_unit_width=104, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x0000, .box_bg_color=0xd804, .box_border_color=0x9383 },
	{ .name="Green House", .year="1982", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x0000, .box_bg_color=0x03ac, .box_border_color=0xac6b },
	{ .name="Donkey Kong II", .year="1983", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0xffff, .box_bg_color=0x6163, .box_border_color=0x9c2b },
	{ .name="Pinball", .year="1983", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0xffff, .box_bg_color=0x0000, .box_border_color=0x93a8 },
	{ .name="Black Jack", .year="1985", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0xffff, .box_bg_color=0x8883, .box_border_color=0x33d6 },
	{ .name="Squish", .year="1986", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0xffff, .box_bg_color=0x6d14, .box_border_color=0xfde8 },
	{ .name="Bomb Sweeper", .year="1987", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x04cd, .box_bg_color=0xee4f, .box_border_color=0xb3e8 },
	{ .name="Safe Buster", .year="1988", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x0000, .box_bg_color=0xd532, .box_border_color=0xfde8 },
	{ .name="Gold Cliff", .year="1988", .img_unit_width=103, .img_unit_height=129, .img_box_width=139, .img_box_height=79, .color_line=2, .text_color=0x0000, .box_bg_color=0x6d78, .box_border_color=0xe5cb },
	{ .name="Zelda", .year="1989", .img_unit_width=103, .img_unit_height=129, .img_box_width=137, .img_box_height=79, .color_line=2, .text_color=0xd126, .box_bg_color=0xc449, .box_border_color=0xd126 }
...
void game_load(int index)
{
	...
	extern const uint8_t gnwsupermariobros_gw_start[] asm("_binary_Game___Watch_Super_Mario_Bros___New_Wide_Screen__gw_start");
	extern const uint8_t gnwsupermariobros_gw_end[] asm("_binary_Game___Watch_Super_Mario_Bros___New_Wide_Screen__gw_end");
	
	extern const uint8_t gnwclimber_gw_start[] asm("_binary_Game___Watch_Climber__New_Wide_Screen__gw_start");
	extern const uint8_t gnwclimber_gw_end[] asm("_binary_Game___Watch_Climber__New_Wide_Screen__gw_end");
	
	extern const uint8_t gnwdballoonfight_gw_start[] asm("_binary_Game___Watch_Balloon_Fight__New_Wide_Screen__gw_start");
	extern const uint8_t gnwdballoonfight_gw_end[] asm("_binary_Game___Watch_Balloon_Fight__New_Wide_Screen__gw_end");
	...
	if (index == 0) {
		...
		button_control_type = BUTTON_CONTROL_TYPE_DPAD;
	}
	else if (index == 19) {
	...
	extern const uint8_t gnwmickeydonald_gw_start[] asm("_binary_Game___Watch_Mickey___Donald_gw_start");
	extern const uint8_t gnwmickeydonald_gw_end[]   asm("_binary_Game___Watch_Mickey___Donald_gw_end");
	...
	extern const uint8_t gnwblackjack_gw_start[] asm("_binary_Game___Watch_Black_Jack_gw_start");
	extern const uint8_t gnwblackjack_gw_end[]   asm("_binary_Game___Watch_Black_Jack_gw_end");

	extern const uint8_t gnwsquish_gw_start[] asm("_binary_Game___Watch_Squish_gw_start");
	extern const uint8_t gnwsquish_gw_end[]   asm("_binary_Game___Watch_Squish_gw_end");
	...
	if (index == 0) {
		...
		button_control_type = BUTTON_CONTROL_TYPE_MULTI_DIRECTION;
	}
	else if (index == 3) {
		...
		button_control_type = BUTTON_CONTROL_TYPE_BLACKJACK;
	}
	else if (index == 7) {
		ROM_DATA = (unsigned char *)gnwsquish_gw_start;
		ROM_DATA_LENGTH = gnwsquish_gw_end - gnwsquish_gw_start;
		button_control_type = BUTTON_CONTROL_TYPE_MULTI_DIRECTION;
		button_control_mode = BUTTON_CONTROL_MODE_SQUISH; 
	}
	else if (index == 8) {
