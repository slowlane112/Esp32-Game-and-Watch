...
unsigned int button_get_two_tropicalfish_buttons(char key) {
...
unsigned int button_get_four_default_buttons(char key) {
...
unsigned int button_get_four_snoopytennis_buttons(char key) {
...
unsigned int button_get_four_marioscementfactory_buttons(char key) {
...
unsigned int button_get_four_flagman_lion_buttons(char key) {
