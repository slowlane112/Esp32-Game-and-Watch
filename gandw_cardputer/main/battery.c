...
static uint16_t battery_high_color = BYTE_SWAP ? 0xe007 : 0x07e0;
static uint16_t battery_medium_color = BYTE_SWAP ? 0xe0ff : 0xffe0;
static uint16_t battery_low_color = BYTE_SWAP ? 0x00f8 : 0xf800;
