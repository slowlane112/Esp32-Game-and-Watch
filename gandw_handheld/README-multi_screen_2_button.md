# Multi Screen 2 Button Handheld
...
Plays 3 two button multi screen game and watch games.
...
In the bottom screen section, trim size of ribbon cable connector adapter board so it will fit in space near the speaker.<br>
...
<tr><td>gnw_opanic</td><td>Game & Watch Oil Panic.gw</td></tr>
<tr><td>gnw_pinball</td><td>Game & Watch Pinball.gw</td></tr>
<tr><td>gnw_sbuster</td><td>Game & Watch Safe Buster.gw</td></tr>
</table>
...
```
idf.py -DDISPLAY=ili9341 -DMODEL=multi_screen_2_button -p /dev/ttyACM0 flash
```

or

```
idf.py -DDISPLAY=st7789 -DMODEL=multi_screen_2_button -p /dev/ttyACM0 flash
```

You can also monitor by adding monitor at the end: 

```
idf.py -DMODEL=multi_screen_2_button -p /dev/ttyACM0 flash monitor 
```
