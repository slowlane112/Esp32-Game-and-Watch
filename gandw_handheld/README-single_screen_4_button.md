...
```
idf.py -DDISPLAY=ili9341 -DMODEL=single_screen_4_button -p /dev/ttyACM0 flash
```

or

```
idf.py -DDISPLAY=st7789 -DMODEL=single_screen_4_button -p /dev/ttyACM0 flash
```

You can also monitor by adding monitor at the end: 

```
idf.py -DMODEL=single_screen_4_button -p /dev/ttyACM0 flash monitor 
```
