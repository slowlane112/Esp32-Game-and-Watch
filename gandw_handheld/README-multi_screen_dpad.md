...
<table>
<tr>
    <td align="center"><img src="../assets/multi_screen_dpad_handheld_1.jpg" alt="Front" width="400"></td>
    <td align="center"><img src="../assets/multi_screen_dpad_handheld_2.jpg" alt="Front" width="400"></td>
</tr>
<tr>
    <td align="center"><img src="../assets/multi_screen_dpad_handheld_3.jpg" alt="Front" width="400"></td>
    <td align="center"><img src="../assets/multi_screen_dpad_handheld_4.jpg" alt="Front" width="400"></td>
</tr>
<tr><td colspan="2"><img src="../assets/multi_dpad_internal.jpg" alt="Internal" width="800"></td></tr>
</table>
...
- ESP32-S3-Zero
- Display: 2 x 2.4 inch SPI panel 240x320 LCD with ILI9341 or ST7789V driver
...
<tr>
    ...
    <td><img src="../assets/perfboard_dpad.jpg" alt="" width="200"></td>
</tr>
</table>
...
Install the ESP-IDF framework. The version I used was v6.0.1.
...
Use LCD-Game-Shrinker to generate a game files (see above) and place the gw files in the /gandw_handheld/main/ directory.

Go back to /gandw_handheld/ directory and open the terminal or cmd window in this directory.
...
```
idf.py -DDISPLAY=ili9341 -DMODEL=multi_screen_dpad -p /dev/ttyACM0 flash
```

or

```
idf.py -DDISPLAY=st7789 -DMODEL=multi_screen_dpad -p /dev/ttyACM0 flash
```

You can also monitor by adding monitor at the end: 

```
idf.py -DMODEL=multi_screen_dpad -p /dev/ttyACM0 flash monitor 
```
...
In the display.c source file, there are 2 commands that you can use to change the screen orientation.
