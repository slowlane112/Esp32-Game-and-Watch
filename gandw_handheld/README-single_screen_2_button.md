...
# Components
- ESP32-S3-Zero
- Display: 2.4 inch SPI panel 240x320 LCD with ILI9341 or ST7789V driver
...
```
idf.py -DDISPLAY=ili9341 -DMODEL=single_screen_2_button -p /dev/ttyACM0 flash
```

or

```
idf.py -DDISPLAY=st7789 -DMODEL=single_screen_2_button -p /dev/ttyACM0 flash
```

You can also monitor by adding monitor at the end: 

```
idf.py -DMODEL=single_screen_2_button -p /dev/ttyACM0 flash monitor 
```
