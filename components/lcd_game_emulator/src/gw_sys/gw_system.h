...
#if defined(MODEL_MULTI_SCREEN_2_BUTTON) || defined(MODEL_MULTI_SCREEN_DPAD) || defined(MODEL_DEMO_MULTI_SCREEN)
	#define GW_SCREEN_WIDTH		320
	#define GW_SCREEN_HEIGHT	420
#elif defined(MODEL_CARDPUTER)    
	#define GW_SCREEN_WIDTH		240
	#define GW_SCREEN_HEIGHT	135
#elif defined(MODEL_CARDPUTER_MULTI_SCREEN)
	#define GW_SCREEN_WIDTH		240
	#define GW_SCREEN_HEIGHT	270
#else
	#define GW_SCREEN_WIDTH 	320
