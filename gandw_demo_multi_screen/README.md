...
Use LCD-Game-Shrinker to generate a rom file for oil panic. Rename the file to gnwoilpanic.gw, and place the file in the /gandw_demo_multi_screen/main/ directory.

Go back to /gandw_demo_multi_screen/ directory and open the terminal or cmd window in this directory.
